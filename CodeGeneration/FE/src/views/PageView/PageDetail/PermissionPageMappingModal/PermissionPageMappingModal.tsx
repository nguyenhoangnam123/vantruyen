...
export interface PagePermissionMappingModalProps extends ContentModalProps<Permission> {
  title: string;
...
function PagePermissionMappingModal(props: PagePermissionMappingModalProps) {
...
export default PagePermissionMappingModal;
