...
// import StoreImageMappingModal from 'views/ImageView/ImageDetail/StoreImageMappingModal/StoreImageMappingModal';
const {Item: FormItem} = Form;

function StoreImageMappingTable(props: ContentTableProps<Image, StoreImageMapping>) {
  ...
  const [
    ...
    handleAdd,
    handleDelete,
  ] = crudService.useContentTable<Image, StoreImageMapping>(
    model,
    setModel,
    ...
    imageRepository.listStoreImageMapping,
    imageRepository.countStoreImageMapping,
    StoreImageMappingFilter,
  );
  ...
  const tableTitle = React.useCallback(
    ...
    <CollapsibleCard title={translate(generalLanguageKeys.actions.search)} className="mb-4">
        {/* <StoreImageMappingModal title={translate('image.storeImageMappingModal.title')}
