...
export class StoreGroupingRepository extends Repository {
  ...
  public count = (storeGroupingFilter?: StoreGroupingFilter): Promise<number> => {
    return this.http.post<number>(kebabCase(nameof(this.count)), storeGroupingFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };

  public list = (storeGroupingFilter?: StoreGroupingFilter): Promise<StoreGrouping[]> => {
    return this.http.post<StoreGrouping[]>(kebabCase(nameof(this.list)), storeGroupingFilter)
  ...
  public get = (id: number | string): Promise<StoreGrouping> => {
    return this.http.post<StoreGrouping>
      (kebabCase(nameof(this.get)), { id })
        .then((response: AxiosResponse<StoreGrouping>) => StoreGrouping.clone<StoreGrouping>(response.data));
  };

  public create = (storeGrouping: StoreGrouping): Promise<StoreGrouping> => {
    return this.http.post<StoreGrouping>(kebabCase(nameof(this.create)), storeGrouping)
      .then((response: AxiosResponse<PureModelData<StoreGrouping>>) => StoreGrouping.clone<StoreGrouping>(response.data));
  };

  public update = (storeGrouping: StoreGrouping): Promise<StoreGrouping> => {
    return this.http.post<StoreGrouping>(kebabCase(nameof(this.update)), storeGrouping)
      .then((response: AxiosResponse<StoreGrouping>) => StoreGrouping.clone<StoreGrouping>(response.data));
  };

  public delete = (storeGrouping: StoreGrouping): Promise<StoreGrouping> => {
      return this.http.post<StoreGrouping>(kebabCase(nameof(this.delete)), storeGrouping)
        .then((response: AxiosResponse<StoreGrouping>) => StoreGrouping.clone<StoreGrouping>(response.data));
  };

  public save = (storeGrouping: StoreGrouping): Promise<StoreGrouping> => {
      return storeGrouping.id ? this.update(storeGrouping) : this.create(storeGrouping);
  };
