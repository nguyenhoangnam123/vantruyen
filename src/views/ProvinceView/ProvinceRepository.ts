...
export class ProvinceRepository extends Repository {
  ...
  public count = (provinceFilter?: ProvinceFilter): Promise<number> => {
    return this.http
      .post<number>(kebabCase(nameof(this.count)), provinceFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };

  public list = (provinceFilter?: ProvinceFilter): Promise<Province[]> => {
    return this.http
      .post<Province[]>(kebabCase(nameof(this.list)), provinceFilter)
  ...
  public get = (id: number | string): Promise<Province> => {
    return this.http
      .post<Province>(kebabCase(nameof(this.get)), { id })
      .then((response: AxiosResponse<Province>) =>
        Province.clone<Province>(response.data),
      );
  };

  public create = (province: Province): Promise<Province> => {
    return this.http
      .post<Province>(kebabCase(nameof(this.create)), province)
  ...
  public update = (province: Province): Promise<Province> => {
    return this.http
      .post<Province>(kebabCase(nameof(this.update)), province)
      .then((response: AxiosResponse<Province>) =>
        Province.clone<Province>(response.data),
      );
  };
  ...
  public delete = (province: Province): Promise<Province> => {
    return this.http
      .post<Province>(kebabCase(nameof(this.delete)), province)
      .then((response: AxiosResponse<Province>) =>
        Province.clone<Province>(response.data),
      );
  };
