...
function DistrictMaster() {
   ...
   * If export
   */
  const [handleExport] = crudService.useExport(API_DISTRICT_ROUTE);
  ...
  const [provinceFilter, setProvinceFilter] = React.useState<DistrictFilter>(new DistrictFilter());
  ...
  const columns: ColumnProps<District>[] = React.useMemo(
    () => {
      ...
      {
          title: translate('districts.provinceId'),
      ...
      {
          title: translate('districts.createdAt'),
      ...
      {
          title: translate('districts.updatedAt'),
      ...
      {
          title: translate('districts.deletedAt'),
      ...
      {
          title: translate('districts.stores'),
      ...
      {
          title: translate('districts.wards'),
          key: nameof(list[0].wards),
          dataIndex: nameof(list[0].wards),
          sorter: true,
          sortOrder: getOrderTypeForTable<District>(
            nameof(list[0].wards),
            sorter,
        ...
        >
          <Spin spinning={previewLoading}>
            <Descriptions title={previewModel.name} bordered>
              ...
              <Descriptions.Item label={translate('districts.id')}>
                { previewModel?.id }
              </Descriptions.Item>
