...
function UnitOfMeasureGroupingContentTable(props: ContentTableProps<UnitOfMeasure, UnitOfMeasureGroupingContent>) {
  ...
  const [
    ...
    handleAdd,
    handleDelete,
  ] = crudService.useContentTable<UnitOfMeasure, UnitOfMeasureGroupingContent>(
    model,
    setModel,
