...
export class UnitOfMeasureRepository extends Repository {
  ...
  public count = (unitOfMeasureFilter?: UnitOfMeasureFilter): Promise<number> => {
    return this.http.post<number>(kebabCase(nameof(this.count)), unitOfMeasureFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };

  public list = (unitOfMeasureFilter?: UnitOfMeasureFilter): Promise<UnitOfMeasure[]> => {
  ...
  public get = (id: number | string): Promise<UnitOfMeasure> => {
    return this.http.post<UnitOfMeasure>
      (kebabCase(nameof(this.get)), { id })
        .then((response: AxiosResponse<UnitOfMeasure>) => UnitOfMeasure.clone<UnitOfMeasure>(response.data));
  };
  ...
  public create = (unitOfMeasure: UnitOfMeasure): Promise<UnitOfMeasure> => {
    return this.http.post<UnitOfMeasure>(kebabCase(nameof(this.create)), unitOfMeasure)
      .then((response: AxiosResponse<PureModelData<UnitOfMeasure>>) => UnitOfMeasure.clone<UnitOfMeasure>(response.data));
  };
