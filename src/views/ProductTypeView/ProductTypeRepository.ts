...
export class ProductTypeRepository extends Repository {
  ...
  public list = (productTypeFilter?: ProductTypeFilter): Promise<ProductType[]> => {
  ...
  public get = (id: number | string): Promise<ProductType> => {
    return this.http.post<ProductType>
      (kebabCase(nameof(this.get)), { id })
        .then((response: AxiosResponse<ProductType>) => ProductType.clone<ProductType>(response.data));
  };
  ...
  public create = (productType: ProductType): Promise<ProductType> => {
    return this.http.post<ProductType>(kebabCase(nameof(this.create)), productType)
      .then((response: AxiosResponse<PureModelData<ProductType>>) => ProductType.clone<ProductType>(response.data));
  };
