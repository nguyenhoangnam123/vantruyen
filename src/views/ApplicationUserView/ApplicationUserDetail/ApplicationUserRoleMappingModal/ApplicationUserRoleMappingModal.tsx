...
export interface ApplicationUserRoleMappingModalProps extends ContentModalProps<Role> {
  title: string;
...
function ApplicationUserRoleMappingModal(props: ApplicationUserRoleMappingModalProps) {
...
export default ApplicationUserRoleMappingModal;
