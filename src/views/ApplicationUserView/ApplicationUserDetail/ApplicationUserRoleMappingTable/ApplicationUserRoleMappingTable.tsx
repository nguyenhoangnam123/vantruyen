...
function ApplicationUserRoleMappingTable(props: ContentTableProps<ApplicationUser, ApplicationUserRoleMapping>) {
  ...
  const [
    ...
    handleAdd,
    handleDelete,
  ] = crudService.useContentTable<ApplicationUser, ApplicationUserRoleMapping>(
    model,
    setModel,
    ...
    applicationUserRepository.listApplicationUserRoleMapping,
    applicationUserRepository.countApplicationUserRoleMapping,
    ApplicationUserRoleMappingFilter,
  );
