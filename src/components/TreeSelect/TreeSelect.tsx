...
const TreeSelectDropdown = React.forwardRef(<T extends Model, TModelFilter extends ModelFilter>
  (props: ITreeSelectProps<T, TModelFilter>, ref: React.Ref<any>) => {
  ...
  const renderTree = React.useCallback(
    ...
    [multiple, treeCheckable, treeDefaultExpandAll, renderItemTree, allowClear, ref],
  );
