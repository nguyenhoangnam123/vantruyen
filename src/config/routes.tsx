...
import AppUserView, { AppUserDetail, AppUserMaster } from 'views/AppUserView/AppUserView';
import DistrictView, { DistrictDetail, DistrictMaster } from 'views/DistrictView/DistrictView';
...
import ProductView, { ProductDetail, ProductMaster } from 'views/ProductView/ProductView';
import ProductGroupingView, { ProductGroupingDetail, ProductGroupingMaster } from 'views/ProductGroupingView/ProductGroupingView';
...
import UnitOfMeasureGroupingContentView, { UnitOfMeasureGroupingContentDetail, UnitOfMeasureGroupingContentMaster } from 'views/UnitOfMeasureGroupingContentView/UnitOfMeasureGroupingContentView';
import UnitOfMeasureGroupingView, { UnitOfMeasureGroupingDetail, UnitOfMeasureGroupingMaster } from 'views/UnitOfMeasureGroupingView/UnitOfMeasureGroupingView';
